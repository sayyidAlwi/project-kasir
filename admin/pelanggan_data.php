              ...
              <tr>
                <?php foreach ($datas_pelanggan as $dt_pelanggan): ?>
                  ...
                  <th>
                    ...
                    <a href="pelanggan_delete.php?PelangganID=<?php echo $dt_pelanggan['PelangganID']; ?>" class="btn btn-danger" title="Delete" role="button" >
...
<div class="modal fade" id="tambah-pelanggan">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="pelanggan_create.php" method="post">
        <div class="modal-body">
          <div class="form-group">
            <label>Nama Pelanggan</label>
